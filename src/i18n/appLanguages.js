...
export const APP_LANGUAGES = [
  ...
  { code: 'cs', nativeLabel: 'Čeština',   englishLabel: 'Czech',      isRTL: false },
  { code: 'da', nativeLabel: 'Dansk',     englishLabel: 'Danish',     isRTL: false },
  ...
  { code: 'fi', nativeLabel: 'Suomi',     englishLabel: 'Finnish',    isRTL: false },
  { code: 'fr', nativeLabel: 'Français', englishLabel: 'French',     isRTL: false },
  { code: 'de', nativeLabel: 'Deutsch',  englishLabel: 'German',     isRTL: false },
  { code: 'el', nativeLabel: 'Ελληνικά', englishLabel: 'Greek',      isRTL: false },
  { code: 'he', nativeLabel: 'עברית',    englishLabel: 'Hebrew',     isRTL: true  },
  { code: 'hi', nativeLabel: 'हिन्दी',    englishLabel: 'Hindi',      isRTL: false },
  { code: 'hu', nativeLabel: 'Magyar',    englishLabel: 'Hungarian',  isRTL: false },
  ...
  { code: 'sv', nativeLabel: 'Svenska',   englishLabel: 'Swedish',    isRTL: false },
